<template>
  <Dialog :open="isOpen" @update:open="handleOpenChange">
    <DialogContent class="max-w-[1400px] w-[90vw] md:w-[95vw] p-0 bg-transparent border-none shadow-none" :show-close-button="false">
      ...
      <div class="w-full aspect-video bg-black rounded-xl md:rounded-lg overflow-hidden shadow-2xl">
        <iframe
          v-if="videoId"
          width="100%"
          height="100%"
